<!-- filepath: c:\laragon\www\login-project\resources\views\prodis\presensidosen.blade.php -->
<!DOCTYPE html>
<html lang="id">
...
<head>
    ...
    <style>
        /* ...existing CSS dari presensimhs.blade.php... */
        * {
...
<body>
        ...
        <ul class="nav-menu">
            ...
            <li class="has-dropdown open">
                ...
                <ul class="submenu" style="display:block;">
                    ...
                    <li>
                        <a href="/prodi/presensi-dosen" class="active">
                            <img src="/images/arrows-up-right.png" alt="" class="submenu-arrow default-arrow">
                            <img src="/images/arrow-ramp-right-3.png" alt="" class="submenu-arrow active-arrow">
                            Dosen
                        </a>
    ...
    <main>
        <div class="title">Presensi Dosen</div>
        <div class="subtitle">Kelola Presensi Dosen dengan Mudah dan Terstruktur</div>
            ...
            <div id="filterDropdown"
                ...
                <div style="margin-bottom:1rem;">
                    ...
                    <select id="filterKelas"
                        ...
                        <option value="TI Malam 2024">TI Malam 2024</option>
                    </select>
                </div>
                <div style="margin-bottom:1rem;">
                    ...
                    <tr>
                        ...
                        <td class="actions" style="text-align:center;">
                            <button class="btn-edit" title="Edit">
                                <img src="/images/edit.png" alt="Edit" style="width:28px;height:28px;">
                            </button>
                            <button class="btn-delete" title="Delete">
                                <img src="/images/delete.png" alt="Hapus" style="width:28px;height:28px;">
                            </button>
                        </td>
                    </tr>
                    <tr>
